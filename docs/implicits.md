...
//   Kleisli(cats.data.Kleisli$$Lambda$2887/0x00000001012db040@21fbfdd5)
// )
...
//   Kleisli(cats.data.Kleisli$$Lambda$2887/0x00000001012db040@3fa8e6ab)
// )
...
//   Kleisli(cats.data.Kleisli$$Lambda$2887/0x00000001012db040@1310b98a)
// )
val columConcatLiterals = concat("this", "is","doric") // concat expects DoricColumn[String] values, the conversion puts them as expected
// columConcatLiterals: StringColumn = TransformationDoricColumn(
//   Kleisli(cats.data.Kleisli$$Lambda$2887/0x00000001012db040@7abdfd36)
