...
//   Kleisli(doric.types.SparkType$$Lambda$2284/806698252@6915351c),
//   "str"
// )
val col2 = colString(c"int")
// col2: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/806698252@4917992b),
//   "int"
// )
val col3 = colInt(c"unknown")
// col3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/806698252@62536882),
//   "unknown"
// )
```
```scala
...
//   Kleisli(doric.types.SparkType$$Lambda$2284/806698252@2bb118ae),
//   "name_user"
// )
colInt(c"age_user")
// res3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/806698252@5e3a5f0c),
//   "age_user"
// )
colString(c"city_user")
// res4: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/806698252@5afaae7e),
//   "city_user"
// )
```
