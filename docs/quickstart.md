...
* The latest experimental version of doric is 0.0.0+1-9b1dd7da-SNAPSHOT.
...
// 'Project [unresolvedalias((value#365 * true), Some(org.apache.spark.sql.Column$$Lambda$5157/0x0000000101bd8040@85d6a17))]
...
//   'Project [unresolvedalias((cast(str#378 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$5157/0x0000000101bd8040@85d6a17))]
