...
//   Kleisli(cats.data.Kleisli$$Lambda$2950/0x0000000100a0e840@5b9b31e0)
// )
...
//   Kleisli(cats.data.Kleisli$$Lambda$2950/0x0000000100a0e840@44946197)
// )
...
//   Kleisli(cats.data.Kleisli$$Lambda$2950/0x0000000100a0e840@156eb4cf)
// )
val columConcatLiterals = concat("this", "is","doric") // concat expects DoricColumn[String] values, the conversion puts them as expected
// columConcatLiterals: StringColumn = TransformationDoricColumn(
//   Kleisli(cats.data.Kleisli$$Lambda$2950/0x0000000100a0e840@644a6ddb)
