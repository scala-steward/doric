...
* The latest experimental version of doric is 0.0.0+1-ef3c245c-SNAPSHOT.
...
// 'Project [unresolvedalias((value#365 * true), Some(org.apache.spark.sql.Column$$Lambda$3805/0x0000000801721040@68545db1))]
...
//   'Project [unresolvedalias((cast(str#378 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$3805/0x0000000801721040@68545db1))]
