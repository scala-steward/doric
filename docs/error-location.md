...
//   Kleisli(doric.types.SparkType$$Lambda$2284/1945313315@62966c9f),
//   "str"
// )
val col2 = colString(c"int")
// col2: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1945313315@6f627a1a),
//   "int"
// )
val col3 = colInt(c"unknown")
// col3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1945313315@655b9169),
//   "unknown"
// )
```
```scala
...
//   Kleisli(doric.types.SparkType$$Lambda$2284/1945313315@27f4761b),
//   "name_user"
// )
colInt(c"age_user")
// res3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1945313315@52df6d0f),
//   "age_user"
// )
colString(c"city_user")
// res4: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1945313315@2bb118ae),
//   "city_user"
// )
```
