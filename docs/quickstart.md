...
* The latest experimental version of doric is 0.0.0+1-7c56afdb-SNAPSHOT.
...
// 'Project [unresolvedalias((value#365 * true), Some(org.apache.spark.sql.Column$$Lambda$5046/0x0000000101b94040@ba3e8b1))]
...
//   'Project [unresolvedalias((cast(str#378 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$5046/0x0000000101b94040@ba3e8b1))]
