...
* The latest experimental version of doric is 0.0.0+1-fb4aed23-SNAPSHOT.
...
// 'Project [unresolvedalias((value#365 * true), Some(org.apache.spark.sql.Column$$Lambda$3804/0x0000000801720840@af5bafb))]
...
//   'Project [unresolvedalias((cast(str#378 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$3804/0x0000000801720840@af5bafb))]
