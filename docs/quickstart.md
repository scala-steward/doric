...
* The latest experimental version of doric is 0.0.0+1-53942042-SNAPSHOT.
...
// 'Project [unresolvedalias((value#257 * true), Some(org.apache.spark.sql.Column$$Lambda$4153/0x0000000101860040@1e5d1b5c))]
...
//   'Project [unresolvedalias((cast(str#270 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$4153/0x0000000101860040@1e5d1b5c))]
