...
//   Kleisli(doric.types.SparkType$$Lambda$2284/1950391386@1067192a),
//   "str"
// )
val col2 = colString(c"int")
// col2: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1950391386@c040c8d),
//   "int"
// )
val col3 = colInt(c"unknown")
// col3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1950391386@3453f79c),
//   "unknown"
// )
```
```scala
...
//   Kleisli(doric.types.SparkType$$Lambda$2284/1950391386@62536882),
//   "name_user"
// )
colInt(c"age_user")
// res3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1950391386@1e9d6c78),
//   "age_user"
// )
colString(c"city_user")
// res4: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2284/1950391386@27f4761b),
//   "city_user"
// )
```
